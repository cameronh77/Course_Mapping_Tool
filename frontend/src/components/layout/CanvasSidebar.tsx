...
export const CanvasSidebar: React.FC<CanvasSidebarProps> = ({
  ...
  return (
    <div className="bg-white p-4 w-full h-full overflow-y-auto flex flex-col">
      ...
      {sidebarTab === 'units' && (
        <div className="animate-fade-in">
          <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-3 shadow-sm transition-colors" onClick={handleSaveCanvas}>
            Save Canvas
          </button>
